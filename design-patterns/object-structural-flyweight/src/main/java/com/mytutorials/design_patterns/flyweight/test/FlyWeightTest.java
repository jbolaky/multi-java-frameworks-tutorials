package com.mytutorials.design_patterns.flyweight.test;
...
import com.mytutorials.design_patterns.flyweight.factory.RectFactory;
...
public class FlyWeightTest extends JFrame {
	...
	private Color[] shapeColor = { Color.orange, Color.red, Color.yellow,
			Color.blue, Color.pink, Color.cyan, Color.magenta, Color.black,
			Color.gray };
		...
		startDrawing.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				for (int i = 0; i < 100000; ++i) {
					 ...
					 * 
					 * g.fillRect(getRandX(), getRandY(), getRandX(),
					 * getRandY());
					 */
