package com.mytutorials.design_patterns.test;
...
import com.mytutorials.design_patterns.caretaker.Caretaker;
import com.mytutorials.design_patterns.originator.Originator;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == undoBut) {
				...
				if (currentArticle >= 1) {
					...
					String textBoxString = originator
