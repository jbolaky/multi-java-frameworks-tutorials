package com.mytutorials.design_patterns.command.test;

import java.util.ArrayList;
import java.util.List;

import com.mytutorials.design_patterns.command.concrete_command.TurnItAllOff;
import com.mytutorials.design_patterns.command.concrete_command.TurnTVOff;
import com.mytutorials.design_patterns.command.concrete_command.TurnTVOn;
import com.mytutorials.design_patterns.command.concrete_command.TurnTVUp;
import com.mytutorials.design_patterns.command.invoker.DeviceButton;
import com.mytutorials.design_patterns.command.receiver.ElectronicDevice;
import com.mytutorials.design_patterns.command.receiver.impl.Radio;
import com.mytutorials.design_patterns.command.receiver.impl.Television;

public class PlayWithDeviceButton {
	...
	public static void main(String[] args) {
		...
		/*
		 * It is common to be able to undo a command in a command pattern To do
		 * so, DeviceButton will have a method called undo Undo() will perform
		 * the opposite action that the normal Command performs. undo() needs to
		 * be added to every class with an execute()
		 */
